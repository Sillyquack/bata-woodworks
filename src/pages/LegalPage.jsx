      ...
      <article className="legal-page">
        ...
        {privacy ? (
          ...
          <>
            ...
            <section><h2>Delivery, delay and changes</h2><p>The offer states pickup or delivery terms and the promised production window. Any material change requires a new offer version; issued commercial terms are not silently edited.</p></section>
